            ...
            class guess_ball_modal(Modal, title="Guess the Altball!!"):
                ...
                async def on_submit(self, interaction: discord.Interaction):
                    if button.disabled != True:
                        ...
                        if (str(self.countryball_answer).lower() == str(correct_countryball).lower()) or (str(correct_countryball).lower() == "united kingdom") and (str(self.countryball_answer).lower() == "uk" or str(self.countryball_answer.lower() == "great britain") or (str(correct_countryball).lower() == "2nd spanish republic") and (str(self.countryball_answer).lower() == "spain" or str(self.countryball_answer).lower() == "republic of spain") or (str(correct_countryball).lower() == "empire of croatia" and str(self.countryball_answer).lower() == "croatia") or (str(correct_countryball).lower() == "empire of algeria" and str(self.countryball_answer).lower() == "algeria") or (str(correct_countryball).lower() == "perso-mesopotamian union") and (str(self.countryball_answer).lower() == "perso mesopotamia" or str(self.countryball_answer).lower() == "persia mesopotamia" or str(self.countryball_answer).lower() == "persio mesopotamian union") or (str(correct_countryball).lower() == "greek republic" and str(self.countryball_answer).lower() == "greece") or (str(correct_countryball).lower() == "united azerbaijan" and str(self.countryball_answer).lower() == "azerbaijan") or (str(correct_countryball).lower() == "united azerbaijan" and str(self.countryball_answer).lower() == "azerbaijan") or (str(correct_countryball).lower() == "magyar fasiszta allam") and (str(self.countryball_answer).lower() == "hungarian fascists" or str(self.countryball_answer).lower() == "hungarian fascist party" or str(self.countryball_answer).lower() == "fascist hungary") or (str(correct_countryball).lower() == "black sea republic" and str(self.countryball_answer).lower() == "black sea") or (str(correct_countryball).lower() == "nordrhein-westfalen" and str(self.countryball_answer).lower() == "north rhine"):
